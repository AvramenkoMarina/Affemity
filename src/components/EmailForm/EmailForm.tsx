...
const EmailForm = () => {
  ...
  return (
    <div className={styles.emailForm}>
      ...
      <p className={styles.emailForm__description}>Please enter your email to see results</p>
      ...
      <div className={styles.emailForm__privacyNotice}>
        <img src={privacy} alt="Privacy" className={styles.emailForm__privacyImage} />
        <p className={styles.emailForm__privacyText}>
          We respect your privacy and are committed to protecting your personal data. We’ll email
          you a copy of your results for convenient access.
        </p>
      </div>
    </div>
  )
