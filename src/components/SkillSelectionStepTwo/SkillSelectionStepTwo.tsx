...
import styles from './SkillSelectionStepTwo.module.scss'
...
const skills: Skill[] = [
  { id: 1, label: 'Skill1_goal2', emoji: '🙌🏻' },
  { id: 2, label: 'Skill2_goal2', emoji: '🥺' },
  { id: 3, label: 'Skill3_goal2', emoji: '⚡' },
  { id: 4, label: 'Skill4_goal2', emoji: '😌' },
  { id: 5, label: 'Skill5_goal2', emoji: '👍' },
]

const currentStep = 1
const totalSteps = 34

export const SkillSelectionStepTwo = () => {
      ...
      <div className={styles.skillsForm__header}>
        ...
        <div className={styles.skillsForm__topBar}>
          ...
          <span className={styles.skillsForm__stepIndicator}>
            <span className={styles.skillsForm__currentStep}>{currentStep}</span>/{totalSteps}
          </span>
        </div>
        ...
        <div className={styles.skillsForm__info}>
          ...
          <p className={styles.skillsForm__description}>Select all that apply</p>
        </div>
      </div>
        ...
        {skills.map((skill) => (
          <li
            ...
            className={`${styles.skillsForm__item} ${
              selectedIds.includes(skill.id) ? styles['skillsForm__item--selected'] : ''
            }`}
